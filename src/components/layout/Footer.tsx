        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-3">
            ...
            <div className="flex flex-col gap-2">
              <Link to="/questions" className="text-sm text-muted-foreground hover:text-foreground transition-colors">Questions</Link>
              <Link to="/courses" className="text-sm text-muted-foreground hover:text-foreground transition-colors">Courses</Link>
              <Link to="/coaching" className="text-sm text-muted-foreground hover:text-foreground transition-colors">Coaching</Link>
            </div>
          </div>
          <div className="space-y-3">

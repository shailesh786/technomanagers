...
import { QuestionsDropdown, CoursesDropdown, MobileQuestionsMenu, MobileCoursesMenu } from './NavDropdown';
    ...
    <nav className="sticky top-0 z-50 border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="container flex h-16 items-center justify-between">
        ...
        <Link to="/" className="flex items-center gap-2">
          <img src={logo} alt="TechnoManagers" width="36" height="36" className="h-9 w-9 object-contain" />
        ...
        <div className="hidden md:flex items-center gap-1">
          <QuestionsDropdown active={location.pathname === '/questions'} />
          <CoursesDropdown active={location.pathname === '/courses'} />
          <Link
            to="/coaching"

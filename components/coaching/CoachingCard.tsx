/**
 * components/coaching/CoachingCard.tsx  —  Server Component ✅
 *
 * No 'use client' needed: pure display component. Receives a CoachingService
 * object as a prop and renders static HTML. External <a> link, no state, no hooks.
 *
 * Changes from src/components/coaching/CoachingCard.tsx:
